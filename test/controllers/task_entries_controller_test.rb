...
class TaskEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_entry" do
    assert_difference('TaskEntry.count') do
      post task_entries_url, params: { task_entry: { duration: @task_entry.duration, note: @task_entry.note, start_time: @task_entry.start_time, task_id: @task_entry.task_id } }
    end
  ...
  test "should update task_entry" do
    patch task_entry_url(@task_entry), params: { task_entry: { duration: @task_entry.duration, note: @task_entry.note, start_time: @task_entry.start_time, task_id: @task_entry.task_id } }
